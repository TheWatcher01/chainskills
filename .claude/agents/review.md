---
name: review
description: "Review and validate completed work for quality, architecture compliance, and correctness -- covers both cli-mcp-core and vscode-extension"
model: sonnet
...
- Dependencies point inward: adapters to core, never reverse
...
When issues are found, suggest invoking @architect to plan improvements.
